  ...
  return (
    <div className="page">
      ...
      <div className="projetos-content">
        ...
        {/* Web Chat Firebase - agora no topo */}
        <div className="projeto-card">
          ...
          <div className="projeto-details">
            ...
            <a href="https://github.com/Arthur-byte-code/WebChatFirebase" target="_blank" rel="noopener noreferrer" className="projeto-button">
              See it on github
            </a>
          </div>
        </div>
